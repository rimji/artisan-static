...
@section('content')
   <small><center>
    Body Oil Care Instructions<br><br>
  <p align="justify">
    ...
    Patch test: Though most people don’t have issues using this oil, people with allergies could have a potential reaction. If you think your skin will react, we recommend performing a 24-hour patch test on your wrist and neck first and slowly integrating this into your routine thereafter. If you do experience an allergic reaction, stop using the product immediately and seek medical attention if needed.<br><br>
