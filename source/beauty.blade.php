...
@section('content')
   <small><center>
    ...
    All Natural.<br>Fragrance Free.<br>Preservative Free.<br>Dye/Colourant Free<br>
   <p align="justify">
    These oils are suitable for everyday use and are recommended for all skin types.<br><br> 
    Note: Our oils are preservative free. Store them away from moisture or any kind of water contamination. Secure the cap tightly after each use. Use these oils within 6 months from opening.<br><br>
    Patch test: Though most people don’t have issues using these oils, people with allergies could have a potential reaction. If you think your skin will react, we recommend performing a 24-hour patch test on your wrist and neck first and slowly integrating them into your routine thereafter. If you do experience an allergic reaction, stop using the product immediately and seek medical attention if needed.<br><br>
